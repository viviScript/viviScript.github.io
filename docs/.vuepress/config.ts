...
const DOMAIN_NAME = 'www.webscript.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'https://github.com/viviScript/', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Vivi', // 必需
      link: 'https://github.com/viviscript', // 可选的
    },
  ...
  plugins: <UserPlugins>[
    ...
    //     choosen: 'gitalk',
    //     options: {
    //       clientID: 'Ov23liSw8vhvymDQjCX9',
    //       clientSecret: 'efe46c2e21ff5a32644e72d2068ceb1dadef4aa8',
    //       repo: 'blog-gitalk-comment', // GitHub 仓库
    //       owner: 'vivi', // GitHub仓库所有者
    //       admin: ['vivi'], // 对仓库有写权限的人
